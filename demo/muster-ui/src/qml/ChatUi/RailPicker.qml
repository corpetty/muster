    ...
    Repeater {
        ...
        delegate: Rectangle {
            ...
            ColumnLayout {
                ...
                // The three facts, as chips — shared with the wallet's own
                // listing of this rail, so what it promises here and what it
                // admits there are one rendering of one struct.
                DisclosureChips {
                    Layout.fillWidth: true
