...
`binding_test`, `safe_owners_test` (exo-45e K3), `material_test` + `offers_test` (exo-45e K2a/K4 — the catalogue + offers, also need $STINT + libsodium), `conformance_test` — the driver conformance suite run against stub +
