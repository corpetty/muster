...
**Status:** design + plan, 2026-09-15. Epic `exo-002` (pebbles). M1 (`exo-002.1`) landed 2026-09-15; M2 (`exo-002.2`), M3 (`exo-002.3`), M8 (`exo-002.8`), M4 (`exo-002.4`) and M5 (`exo-002.5`) landed 2026-09-16. Remaining: M6 (SDK) and M7 (upstream).
